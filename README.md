...
| [`icloud-drive-mcp`](https://github.com/robworks-code/icloud-drive-mcp) | productivity | MCP server for managing iCloud Drive files via the local sync folder — list, read, write, delete, move, and search files, plus file/dir info. macOS only. | `MIT` | `v1.0.1` |  |
