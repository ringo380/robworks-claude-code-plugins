...
| [`cpanel-mcp`](https://github.com/ringo380/claude-cpanel-mcp) | infrastructure | cPanel UAPI MCP server - 74 tools for email, DNS, file read and write, MySQL, FTP, SSL, cron, subdomains, addon domains, and backups on shared cPanel hosting. Multi-account profiles with atomic token rotation, dry-run auth_test, cPHulk lockout detection, POST routing that keeps secrets out of the cPanel access log, and a state-machine /cpanel-mcp:setup. | `MIT` | [`v0.4.2`](https://github.com/ringo380/claude-cpanel-mcp/releases/tag/v0.4.2) | [ringo380/claude-cpanel-mcp](https://github.com/ringo380/claude-cpanel-mcp) |
